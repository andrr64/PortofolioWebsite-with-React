...
const LatarBelakangPage: React.FC = () => {
  ...
  // Tema: Pembuatan Todos App menggunakan React Native + Expo
  // Isi:
  // - Mengapa membuat Todos App
  // - Alasan teknis dan manfaat sebagai latihan
  // - Todos App sebagai latihan CRUD dengan expo-sqlite
      ...
      <div className="max-w-6xl space-y-8">
        ...
        <header className="text-left">
          ...
          <p className="text-gray-600 mt-2 text-lg">
            Mengapa kita membangun aplikasi <i>Todos App</i> dengan React Native + Expo?
          </p>
        </header>
        ...
        <section className="bg-white p-6 rounded-xl shadow-md space-y-6">
          <h2 className="text-2xl font-semibold text-gray-800">
            Mengapa Memilih Todos App?
          </h2>
          <p className="text-gray-700 leading-relaxed">
            Dalam mempelajari pengembangan aplikasi mobile, kita membutuhkan contoh
            proyek yang sederhana namun tetap bermanfaat. Aplikasi <b>Todos</b>
            dipilih karena:
          </p>

          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Mudah dipahami oleh pemula.</li>
            <li>Memiliki fitur inti yang sering digunakan (tambah, edit, hapus, centang tugas selesai).</li>
            <li>Relevan dengan aktivitas sehari-hari, karena setiap orang butuh mengatur tugas.</li>
          </ul>
          ...
          <p className="text-gray-700 leading-relaxed">
            Dengan membangun Todos App, kita bisa memahami beberapa konsep penting
            dalam React Native, antara lain:
          </p>

          <ul className="list-disc list-inside text-gray-700 space-y-2">
            <li>Pengenalan komponen dasar React Native.</li>
            <li>Pengelolaan state untuk menyimpan daftar tugas.</li>
          ...
          <p className="text-gray-700 leading-relaxed">
            Dengan begitu, Todos App bukan hanya sekadar aplikasi sederhana,
        ...
        <section className="bg-blue-50 p-6 rounded-xl border border-blue-200">
          ...
          <ul className="list-disc list-inside text-gray-700 mt-2 space-y-1">
            <li>Todos App dipilih karena sederhana dan relevan.</li>
